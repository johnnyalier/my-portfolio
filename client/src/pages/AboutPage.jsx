...
const AboutPage = () => {
    ...
    return (
        <div className='min-h-screen max-w-6xl mx-auto flex flex-col justify-between items-center pt-5'>
            <div className='mx-4 h-full flex flex-col md:flex-row justify-between px-5 gap-10'>
                ...
                <div className='flex-1 h-full'>
                    <div className='flex flex-col justify-center items-center mx-auto gap-5'>
                        ...
                        <h3 className='font-extrabold text-md text-wrap md:text-3xl'>
                            I Develop Software Systems that Solve Real World Problems.
                        </h3>
                        <div className='text-justify text-xs md:text-xl pt-5'>
                        ...
                        <div className='flex justify-between items-start gap-5 text-xs md:text-xl'>
            ...
            <div className='w-screen bg-slate-800 flex justify-center items-center mb-5'>
                <div className='flex flex-row justify-between items-center py-10 px-5 gap-5'>
                    <div className='flex gap-2 items-center'>
                        <h1 className='text-green-600 text-lg md:text-6xl font-bold'>{experienceSummary.duration}+</h1>
                        <h2 className='text-white text-xs md:text-3xl'>Years of Experience</h2>
                    </div>                
                    <div className='flex gap-2 items-center'>
                        <h1 className='text-green-600 text-lg md:text-6xl font-bold'>{experienceSummary.clients}+</h1>
                        <h2 className='text-white text-xs md:text-3xl'>Clients</h2>
                    </div>                
                    <div className='flex gap-2 items-center'>
                        <h1 className='text-green-600 text-lg md:text-6xl font-bold'>{experienceSummary.projects}+</h1>
                        <h2 className='text-white text-xs md:text-3xl'>Total Projects</h2>
                    </div>                
                </div>
            </div>
